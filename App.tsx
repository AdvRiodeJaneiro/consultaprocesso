...
export default function App() {
  ...
  const getActiveTitle = () => {
    switch(activeView) {
      case 'monitor-new': return 'Monitoramento';
      case 'search-person': return 'Busca por Nome/CPF';
      case 'search-number': return 'Consulta Processo';
        ...
        <div className="max-w-md space-y-4">
          <div className="bg-white dark:bg-slate-900 p-10 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl inline-block">
             ...
             <p className="text-slate-500 mt-2 font-medium">
               Estamos preparando a tela de "{getActiveTitle()}" para você.
             </p>
          </div>
        </div>
      </div>
