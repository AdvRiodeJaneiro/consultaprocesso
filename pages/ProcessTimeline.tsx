  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950">
        ...
        <p className="text-slate-500 font-bold animate-pulse">Sincronizando dados e gerando análise técnica...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
        ...
        {/* LEFT COLUMN: AI Analysis (The noble space) */}
        ...
        {/* RIGHT SIDEBAR: Process Info & Raw Timeline */}
            ...
            <div>
              ...
              <div className="space-y-5">
                <DetailItem 
                  icon={<Scale size={16} />} 
                  label="Assunto" 
                  value={processData.fontes?.[0]?.capa?.assunto || "Não informado"} 
                />
                <DetailItem 
                  icon={<User size={16} />} 
                  label="Polo Ativo" 
                  value={processData.titulo_polo_ativo || "Não informado"} 
                />
                <DetailItem 
                  icon={<User size={16} />} 
                  label="Polo Passivo" 
                  value={processData.titulo_polo_passivo || "Não informado"} 
                />
                <DetailItem 
                ...
                <DetailItem 
                  ...
                  value={processData.fontes?.[0]?.capa?.orgao_julgador || "Não informado"} 
                />
              </div>
            </div>
