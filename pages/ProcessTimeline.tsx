        ...
        <div className="lg:hidden">
          ...
          <motion.div
            ...
            onDragEnd={(_, info) => {
                ...
                else if (info.offset.y > 50) setIsSheetOpen(false);
            }}
            animate={{ y: isSheetOpen ? 0 : "calc(100% - 70px)" }}
            transition={{ type: "spring", damping: 30, stiffness: 300 }}
            className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 rounded-t-[32px] shadow-[0_-10px_40px_rgba(0,0,0,0.3)] border-t border-slate-200 dark:border-slate-800 z-[80] flex flex-col max-h-[90vh] touch-none"
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-10 scrollbar-hide touch-auto">
              <InfoContent />
            </div>
          </motion.div>
        </div>
